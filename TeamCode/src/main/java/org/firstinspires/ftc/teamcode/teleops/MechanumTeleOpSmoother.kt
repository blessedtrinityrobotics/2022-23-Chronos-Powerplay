...
@TeleOp(name="Mechanum TeleOp Smoother Edition")
class MechanumTeleOpSmoother : BaseTeleOp() {
    override fun drive() {

        val multiplier = if (gamepad1.right_bumper) 0.75 else if (gamepad1.left_bumper) 0.5 else 1.0
